...
func SetOriginalReplicas(originalReplicas int, workload scalable.Workload) {
...
func GetOriginalReplicas(workload scalable.Workload) (int, error) {
	annotations := workload.GetAnnotations()
...
func RemoveOriginalReplicas(workload scalable.Workload) {
	annotations := workload.GetAnnotations()
