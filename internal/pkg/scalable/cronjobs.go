...
func getCronJobs(namespace string, clientset *kubernetes.Clientset, ctx context.Context) ([]Workload, error) {
...
func (c CronJob) Update(clientset *kubernetes.Clientset, ctx context.Context) error {
