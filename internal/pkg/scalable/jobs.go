...
func getJobs(namespace string, clientset *kubernetes.Clientset, ctx context.Context) ([]Workload, error) {
...
func (j Job) Update(clientset *kubernetes.Clientset, ctx context.Context) error {
