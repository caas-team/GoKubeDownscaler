...
// horizontalPodAutoscaler is a wrapper for autoscaling/v2.horizontalPodAutoscaler to implement the replicaScaledWorkloadto implement the Workload interface interface
