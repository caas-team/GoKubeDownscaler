...
type Client interface {
	...
	DownscaleWorkload(replicas scalable.ReplicaCount, workload scalable.Workload, ctx context.Context) error
...
// DownscaleWorkload downscales the workload to the specified replicas.
func (c client) DownscaleWorkload(replicas scalable.ReplicaCount, workload scalable.Workload, ctx context.Context) error {
