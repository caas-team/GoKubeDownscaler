...
Or you can follow [these instructions][go-install] to install go another way.
...
The user of the selected context has to have the [permissions required to scale][docs-helm-permissions].
...
This is only necessary for eg. testing the docker image.
...
Disabling CGO isn't strictly required although it does sometimes lead to problems.
