...
This will intern retrigger [the workflow](ref:docs-workflows#check-for-release) run which then automatically removes the <GithubLabel label="needs approval"/> label and allows for the pull request to be merged.
