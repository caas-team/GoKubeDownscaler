...
This will in turn retrigger [the workflow](ref:docs-workflows#check-for-release) run which then automatically removes the <GithubLabel label="needs approval"/> label and allows the pull request to be merged.
