...
Docusaurus will automatically build the changes and add the file as a entry into the sidebar.
...
Docusaurus caches a most files and doesn't rebuild them until they themselves change (eg. rendered markdown files, [SVGO][svgo]/[SVGR][svgr] optimized SVGs, etc.).
