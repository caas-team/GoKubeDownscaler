...
description: >
  Reduce cloud costs by automatically scaling down non-production Kubernetes workloads at night and
  on weekends using GoKubeDownscaler scheduling annotations.
...
<script type="application/ld+json">
  {JSON.stringify({
    ...
    description:
      "How to use kube-downscaler for night time and weekends cost savings on Kubernetes " +
