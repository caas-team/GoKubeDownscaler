...
description: Reduce cloud costs by automatically scaling down non-production Kubernetes workloads at night and on weekends using GoKubeDownscaler scheduling annotations.
