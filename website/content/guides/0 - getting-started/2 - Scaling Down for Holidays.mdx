...
description: Cut cloud infrastructure costs by automatically scaling down Kubernetes workloads during holidays and long weekends using GoKubeDownscaler schedules.
...
<script type="application/ld+json">
  {JSON.stringify({
    ...
    "@type": "TechArticle",
    "@id":
      "https://kube-downscaler.io/guides/scaling-down-for-holidays#techarticle",
    headline: "Scaling Down for Holidays with GoKubeDownscaler",
    description:
      "How to configure GoKubeDownscaler to scale clusters, namespaces, and workloads down for holiday windows using force downtime and annotations.",
    articleSection: "Getting Started - Holidays",
    keywords: [
      "holidays",
      "force-downtime",
      "annotations",
    ...
    url: "https://kube-downscaler.io/guides/scaling-down-for-holidays",
    image: "https://kube-downscaler.io/img/social-preview.png",
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://kube-downscaler.io/guides/scaling-down-for-holidays",
    },
...
The only difference is that this will not allow you to use any of the downscaler's functionality on this workload.
