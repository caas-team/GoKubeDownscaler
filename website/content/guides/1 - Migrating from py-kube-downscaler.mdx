...
[Exclusion Upscale](ref:docs-values#exclusion-upscale) value inside [CLI Scope](ref:docs-cli-scope#values),
[Namespace Scope](ref:docs-namespace-scope#values) or [Workload Scope](ref:docs-workload-scope#values).
