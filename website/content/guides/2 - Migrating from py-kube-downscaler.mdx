...
description: Step-by-step guide to migrate from py-kube-downscaler to GoKubeDownscaler: update your values.yaml, map annotations, and handle breaking changes easily.
keywords: [py-kube-downscaler, migration]
---

# Migrating From Py-Kube-Downscaler

In most cases it's very simple to migrate and steps 3 and 4 can be skipped.
...
This makes it so you don't have to have access to the downscaler's console just to see what's wrong with your configuration.
