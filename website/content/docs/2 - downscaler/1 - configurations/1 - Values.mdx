...
description: >
  Discover all annotation values available in GoKubeDownscaler to control downscaling schedules,
  replica counts, timespans, and more for Kubernetes workloads.
keywords: [values]
---
...
<script type="application/ld+json">
  {JSON.stringify({
    ...
    description:
      "Discover all annotation values available in GoKubeDownscaler to control " +
      "downscaling schedules, replica counts, timespans, and more for Kubernetes workloads.",
