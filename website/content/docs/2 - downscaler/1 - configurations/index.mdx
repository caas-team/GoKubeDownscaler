...
description: Browse all GoKubeDownscaler configuration options including runtime flags, environment variables, and annotation values to control Kubernetes downscaling.
...
<script type="application/ld+json">
  {JSON.stringify({
    ...
    description:
      "Browse all GoKubeDownscaler configuration options including runtime flags, environment variables, and annotation values to control Kubernetes downscaling.",
