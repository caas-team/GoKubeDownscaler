...
description: >
  Learn how to define timespans in GoKubeDownscaler to specify scaling schedules using time ranges,
  weekdays, and recurring patterns for Kubernetes workloads.
keywords:
  - timespans
  - absolute timespans
  - relative timespans
...
<script type="application/ld+json">
  {JSON.stringify({
    ...
    description:
      "Learn how to define timespans in GoKubeDownscaler to specify scaling schedules " +
      "using time ranges, weekdays, and recurring patterns for Kubernetes workloads.",
