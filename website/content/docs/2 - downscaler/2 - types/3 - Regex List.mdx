...
description: Learn how to use regex lists in GoKubeDownscaler to match multiple Kubernetes workloads or namespaces using regular expression patterns in annotation values.
keywords: [regex lists, regex]
---
...
<script type="application/ld+json">
  {JSON.stringify({
    ...
    "@type": "TechArticle",
    "@id": "https://kube-downscaler.io/docs/regex-list#techarticle",
    headline: "Regex List — GoKubeDownscaler",
    description:
      "Learn how to use regex lists in GoKubeDownscaler to match multiple Kubernetes workloads or namespaces using regular expression patterns in annotation values.",
    articleSection: "Types - Regex List",
    keywords: ["regex list", "patterns", "matching", "regular expressions"],
    url: "https://kube-downscaler.io/docs/regex-list",
    image: "https://kube-downscaler.io/img/social-preview.png",
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://kube-downscaler.io/docs/regex-list",
    },
