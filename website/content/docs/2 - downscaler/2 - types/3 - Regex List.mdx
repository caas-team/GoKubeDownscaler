...
description: >
  Learn how to use regex lists in GoKubeDownscaler to match multiple Kubernetes workloads or
  namespaces using regular expression patterns in annotation values.
...
<script type="application/ld+json">
  {JSON.stringify({
    ...
    description:
      "Learn how to use regex lists in GoKubeDownscaler to match multiple Kubernetes workloads " +
      "or namespaces using regular expression patterns in annotation values.",
