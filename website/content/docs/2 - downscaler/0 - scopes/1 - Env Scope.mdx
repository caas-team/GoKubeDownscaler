...
description: Configure the GoKubeDownscaler environment variable scope to set default uptime and downtime schedules for your Kubernetes workloads without annotations.
...
<script type="application/ld+json">
  {JSON.stringify({
    ...
    "@type": "TechArticle",
    "@id": "https://kube-downscaler.io/docs/env-scope#techarticle",
    headline: "Env Scope — GoKubeDownscaler",
    description:
      "Configure the GoKubeDownscaler environment variable scope to set default uptime and downtime schedules for your Kubernetes workloads without annotations.",
    articleSection: "Scopes - Environment Variables",
    keywords: ["env scope", "environment variables", "scopes", "configuration"],
    url: "https://kube-downscaler.io/docs/env-scope",
    image: "https://kube-downscaler.io/img/social-preview.png",
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://kube-downscaler.io/docs/env-scope",
    },
...
- [DEFAULT_TIMEZONE](ref:docs-values#timezone)
- [DEFAULT_WEEKFRAME](ref:docs-values#weekframe)
