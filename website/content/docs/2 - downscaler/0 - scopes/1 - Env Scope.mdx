...
description: >
  Configure the GoKubeDownscaler environment variable scope to set default uptime and downtime
  schedules for your Kubernetes workloads without annotations.
...
<script type="application/ld+json">
  {JSON.stringify({
    ...
    description:
      "Configure the GoKubeDownscaler environment variable scope to set default uptime " +
      "and downtime schedules for your Kubernetes workloads without annotations.",
