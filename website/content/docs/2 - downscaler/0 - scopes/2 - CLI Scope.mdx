...
description: Learn how to configure the CLI argument scope in GoKubeDownscaler to pass downscaling flags and arguments directly to the downscaler process at runtime.
...
<script type="application/ld+json">
  {JSON.stringify({
    ...
    description:
      "Learn how to configure the CLI argument scope in GoKubeDownscaler to pass downscaling flags and arguments directly to the downscaler process at runtime.",
