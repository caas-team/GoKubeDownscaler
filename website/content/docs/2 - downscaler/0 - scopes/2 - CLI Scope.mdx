...
description: >
  Learn how to configure the CLI argument scope in GoKubeDownscaler to pass downscaling flags and
  arguments directly to the downscaler process at runtime.
...
<script type="application/ld+json">
  {JSON.stringify({
    ...
    "@type": "TechArticle",
    "@id": "https://kube-downscaler.io/docs/cli-scope#techarticle",
    headline: "CLI Scope — GoKubeDownscaler",
    description:
      "Learn how to configure the CLI argument scope in GoKubeDownscaler to pass " +
      "downscaling flags and arguments directly to the downscaler process at runtime.",
    articleSection: "Scopes - CLI Arguments",
    keywords: ["cli scope", "arguments", "flags", "configuration"],
    url: "https://kube-downscaler.io/docs/cli-scope",
    image: "https://kube-downscaler.io/img/social-preview.png",
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://kube-downscaler.io/docs/cli-scope",
    },
...
Arguments flagged with an asterisk (\*) cannot be set inside the Webhook
while arguments flagged with a hashtag (#) can only be set inside the Webhook.
...
- [--qps](ref:docs-runtime-configuration#qps)
- [--burst](ref:docs-runtime-configuration#burst)
- [--timeout](ref:docs-runtime-configuration#timeout)
- [--json-logs](ref:docs-runtime-configuration#json-logs)
...
The value of a boolean cli flag can be omitted.
