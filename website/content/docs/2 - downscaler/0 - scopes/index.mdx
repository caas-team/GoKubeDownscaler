...
description: Understand how GoKubeDownscaler scopes work: from default to workload-level, learn the scope hierarchy and how scaling values are inherited and overridden.
...
<script type="application/ld+json">
  {JSON.stringify({
    ...
    "@type": "TechArticle",
    "@id": "https://kube-downscaler.io/docs/scopes-and-scaling#techarticle",
    headline: "Scopes and Scaling — GoKubeDownscaler",
    description:
      "Detailed explanation of the scaling algorithm used by GoKubeDownscaler, including exclusions and the optional admission algorithm.",
    articleSection: "Downscaler - Scopes",
    keywords: ["scaling", "algorithm", "exclusions", "admission webhook"],
    url: "https://kube-downscaler.io/docs/scopes-and-scaling",
    image: "https://kube-downscaler.io/img/social-preview.png",
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://kube-downscaler.io/docs/scopes-and-scaling",
    },
...
It can be visualized as a pyramid, with the Default Scope at the bottom and the Workload Scope at the top.
...
The admission algorithm can be enabled by setting the `webhookController.enabled` value to `true` in the [Helm Chart](ref:docs-helm-webhook-controller-enabled)
