...
description: >
  Understand how GoKubeDownscaler scopes work: from default to workload-level, learn the scope
  hierarchy and how scaling values are inherited and overridden.
...
<script type="application/ld+json">
  {JSON.stringify({
    ...
    description:
      "Detailed explanation of the scaling algorithm used by GoKubeDownscaler, including" +
      " exclusions and the optional admission algorithm.",
