...
description: Learn how to configure the workload scope in GoKubeDownscaler using annotations on individual Kubernetes workloads for fine-grained downscaling control.
...
<script type="application/ld+json">
  {JSON.stringify({
    ...
    description:
      "Learn how to configure the workload scope in GoKubeDownscaler using annotations on individual Kubernetes workloads for fine-grained downscaling control.",
