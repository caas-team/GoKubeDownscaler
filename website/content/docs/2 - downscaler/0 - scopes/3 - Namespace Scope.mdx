...
description: Learn how to configure the namespace scope in GoKubeDownscaler using annotations on Kubernetes namespaces to control downscaling for all workloads within.
...
<script type="application/ld+json">
  {JSON.stringify({
    ...
    "@type": "TechArticle",
    "@id": "https://kube-downscaler.io/docs/namespace-scope#techarticle",
    headline: "Namespace Scope — GoKubeDownscaler",
    description:
      "Learn how to configure the namespace scope in GoKubeDownscaler using annotations on Kubernetes namespaces to control downscaling for all workloads within.",
    articleSection: "Scopes - Namespace Annotations",
    keywords: ["namespace scope", "annotations", "namespace", "kubernetes"],
    url: "https://kube-downscaler.io/docs/namespace-scope",
    image: "https://kube-downscaler.io/img/social-preview.png",
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://kube-downscaler.io/docs/namespace-scope",
    },
