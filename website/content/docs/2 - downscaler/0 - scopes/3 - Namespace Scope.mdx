...
description: >
  Learn how to configure the namespace scope in GoKubeDownscaler using annotations on Kubernetes
  namespaces to control downscaling for all workloads within.
...
<script type="application/ld+json">
  {JSON.stringify({
    ...
    description:
      "Learn how to configure the namespace scope in GoKubeDownscaler using annotations" +
      " on Kubernetes namespaces to control downscaling for all workloads within.",
