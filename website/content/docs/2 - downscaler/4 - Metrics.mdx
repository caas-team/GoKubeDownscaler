...
description: Reference all Prometheus metrics on the /metrics port 8085 exposed by GoKubeDownscaler, including dry-run metrics and Grafana dashboard integration.
keywords: [metrics]
---
