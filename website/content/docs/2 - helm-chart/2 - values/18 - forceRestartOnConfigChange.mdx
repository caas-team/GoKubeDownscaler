---
title: forceRestartOnConfigChange | GoKubeDownscaler
...
keywords: [kube downscaler, helm chart, forceRestartOnConfigChange, cloud, kubernetes, eks, gke, aks, cost optimization]
---
