---
title: admissionControllerImage
id: admissionControllerImage
globalReference: docs-helm-admission-controller-image
description: How to specify a custom image for the GoKubeDownscaler Webhook Deployment
keywords: [admissionControllerImage]
---

# admissionController.image

The `admissionController.image` value contains the three fields `repository`, `pullPolicy` and `tag`:
...
The default values for `admissionController.image` are:
