---
title: nodeSelector | GoKubeDownscaler
id: nodeSelector
globalReference: docs-helm-node-selector
description: How to set nodeSelector for the GoKubeDownscaler
keywords: [kube downscaler, helm chart, nodeSelector, cloud, kubernetes, eks, gke, aks, cost optimization]
---
