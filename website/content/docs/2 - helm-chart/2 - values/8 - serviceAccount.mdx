---
title: serviceAccount | GoKubeDownscaler
id: serviceAccount
globalReference: docs-helm-service-account
description: How to set serviceAccount for the GoKubeDownscaler
keywords: [kube downscaler, helm chart, serviceAccount, cloud, kubernetes, eks, gke, aks, cost optimization]
---
