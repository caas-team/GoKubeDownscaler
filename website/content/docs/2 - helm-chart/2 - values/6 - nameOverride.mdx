---
title: nameOverride | GoKubeDownscaler
id: nameOverride
globalReference: docs-helm-name-override
description: How to set nameOverride value for the GoKubeDownscaler
keywords: [kube downscaler, helm chart, nameOverride, cloud, kubernetes, eks, gke, aks, cost optimization]
---
