---
title: image | GoKubeDownscaler
id: image
globalReference: docs-helm-image
description: How to specify a custom image for the GoKubeDownscaler Deployment
keywords: [kube downscaler, helm chart, image, cloud, kubernetes, eks, gke, aks, cost optimization]
---
