---
title: constrainedNamespaces | GoKubeDownscaler
id: constrainedNamespaces
globalReference: docs-helm-constrained-namespaces
description: How to set constrainedNamespaces value for the GoKubeDownscaler
keywords: [kube downscaler, helm chart, constrainedNamespaces, cloud, kubernetes, eks, gke, aks, cost optimization]
---
