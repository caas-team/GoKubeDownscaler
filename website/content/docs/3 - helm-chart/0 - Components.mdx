...
description: Complete list of all Kubernetes components deployed by the GoKubeDownscaler Helm chart, including Deployments, Services, RBAC roles, and webhook resources.
