...
description: Learn how to configure cert-manager integration for the GoKubeDownscaler Webhook controller using the webhookControllerCertManager Helm chart value.
keywords: [webhookControllerCertManager, certManager]
---

# webhookController.certManager

The `webhookController.certManager` defines all the values needed to configure cert-manager for the Webhook.
