...
description: Learn how to configure pod affinity and anti-affinity rules for GoKubeDownscaler using the affinity Helm value to control pod scheduling in your cluster.
keywords: [affinity]
---
