---
title: webhookControllerAffinity
id: webhookControllerAffinity
globalReference: docs-helm-webhook-controller-affinity
description: Learn how to configure affinity and anti-affinity rules for the GoKubeDownscaler Webhook controller using the webhookControllerAffinity Helm chart value.
keywords: [webhookControllerAffinity]
---

# webhookController.affinity

The `webhookController.affinity` value defines rules for node affinity and pod affinity/anti-affinity.

:::info

The default value for `webhookController.affinity` is:
...
By default the `webhookController.affinity` field is empty.
