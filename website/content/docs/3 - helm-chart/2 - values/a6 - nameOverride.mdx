...
description: >
  Learn how to use the nameOverride Helm value to customize the base name of GoKubeDownscaler
  Kubernetes resources deployed via the Helm chart release name.
