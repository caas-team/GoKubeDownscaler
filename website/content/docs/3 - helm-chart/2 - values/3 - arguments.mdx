...
description: Learn how to pass custom command-line arguments to the GoKubeDownscaler container using the arguments Helm value to configure downscaler runtime behavior.
keywords: [arguments]
---
