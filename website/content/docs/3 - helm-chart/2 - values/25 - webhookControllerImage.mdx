...
description: Learn how to specify a custom container image for the GoKubeDownscaler Webhook controller using the webhookControllerImage Helm chart value and pull policy.
