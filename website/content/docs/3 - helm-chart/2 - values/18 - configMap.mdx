...
description: Learn how to configure the GoKubeDownscaler ConfigMap Helm value to pass runtime configuration and environment variables to the downscaler deployment.
keywords: [configMap]
---
...
- `extraConfig` adds additional specified [environment variables](ref:docs-env-scope) to the ConfigMap.
...
Appending a line will add the corresponding [environment variable](ref:docs-env-scope) to the configMap.
...
You can find a list of all possible environment variables on [our documentation page](ref:docs-env-scope).
