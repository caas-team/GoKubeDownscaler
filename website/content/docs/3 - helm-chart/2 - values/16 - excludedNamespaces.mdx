...
description: Use the excludedNamespaces Helm value to prevent GoKubeDownscaler from scaling down workloads in specific Kubernetes namespaces you want to keep always running.
