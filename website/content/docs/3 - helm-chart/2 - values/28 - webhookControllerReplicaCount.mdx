...
description: >
  Learn how to configure the replica count for the GoKubeDownscaler Webhook controller Deployment
  using the webhookControllerReplicaCount Helm chart value.
