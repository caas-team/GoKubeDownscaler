...
description: >
  Learn how to configure affinity and anti-affinity rules for the GoKubeDownscaler Webhook controller
  using the webhookControllerAffinity Helm chart value.
