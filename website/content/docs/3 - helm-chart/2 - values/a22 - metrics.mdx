...
description: >
  Learn how to enable and configure Prometheus metrics for GoKubeDownscaler using the metrics Helm
  value to monitor scaling activity in your Kubernetes cluster.
keywords: [metrics]
---
