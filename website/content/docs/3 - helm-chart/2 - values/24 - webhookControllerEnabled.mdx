...
description: Learn how to enable the GoKubeDownscaler Webhook controller using the webhookControllerEnabled Helm value to enforce annotation compliance in your cluster.
