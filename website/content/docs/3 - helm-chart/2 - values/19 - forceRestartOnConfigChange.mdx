...
description: Learn how to enable forceRestartOnConfigChange in GoKubeDownscaler to automatically restart pods whenever the ConfigMap configuration is updated in Kubernetes.
keywords: [forceRestartOnConfigChange]
---

# forceRestartOnConfigChange

The `forceRestartOnConfigChange` value defines whether the pods of the GoKubeDownscaler should be restarted
when changing the config in the configMap.
:::info
