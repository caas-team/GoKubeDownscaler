...
description: Learn how to configure Kubernetes tolerations for the GoKubeDownscaler Deployment using the tolerations Helm chart value to allow scheduling on tainted nodes.
