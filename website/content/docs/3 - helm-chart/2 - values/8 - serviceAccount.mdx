...
description: Learn how to configure the Kubernetes ServiceAccount for GoKubeDownscaler using the serviceAccount Helm value, including custom names and annotation support.
keywords: [serviceAccount]
---

# serviceAccount

The `serviceAccount` value contains the three fields `create`, `annotations` and `name`:
