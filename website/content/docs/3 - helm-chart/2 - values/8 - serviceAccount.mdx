...
description: >
  Learn how to configure the Kubernetes ServiceAccount for GoKubeDownscaler using the serviceAccount
  Helm value, including custom names and annotation support.
