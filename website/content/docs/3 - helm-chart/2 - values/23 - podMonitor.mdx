...
description: Learn how to enable and configure a Prometheus PodMonitor for GoKubeDownscaler to automatically scrape downscaler metrics in your Kubernetes cluster setup.
keywords: [podmonitor]
---
