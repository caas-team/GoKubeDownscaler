...
description: >
  Learn how to configure the constrainedNamespaces Helm value to limit GoKubeDownscaler to only
  monitor and scale workloads in specific Kubernetes namespaces.
