...
description: Learn how to specify a custom container image for the GoKubeDownscaler Deployment using the image Helm value, including repository, tag, and pull policy.
keywords: [image, image registry]
---
