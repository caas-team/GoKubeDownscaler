...
description: >
  Learn how to enable forceRestartOnConfigChange in GoKubeDownscaler to automatically restart pods
  whenever the ConfigMap configuration is updated in Kubernetes.
