...
description: Learn how to enable annotationsCompliance in GoKubeDownscaler to prevent unauthorized creation, modification, or deletion of reserved downscaler annotations.
