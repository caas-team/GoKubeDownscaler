...
description: >
  Learn how to use the nodeSelector Helm value to schedule GoKubeDownscaler pods on specific
  Kubernetes nodes based on node labels defined in your cluster.
