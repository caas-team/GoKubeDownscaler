...
If (ref:docs-helm-constrained-downscaler)(ref:docs-helm-constrained-downscaler) is set to true the Helm Chart will create roles for each namespace defined in (ref:docs-helm-constrained-namespaces)(ref:docs-helm-constrained-namespaces).
...
The Helm Chart assigns get, watch, list, update and patch permissions for the workloads defined in (ref:docs-helm-included-resources)(ref:docs-helm-included-resources).
