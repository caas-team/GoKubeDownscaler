...
You can add affinity rules to this field that give you a few more options for pod scheduling than (ref:docs-helm-node-selector)(ref:docs-helm-node-selector).

## Node affinity

You can use Node affinity to achieve something very similar to the (ref:docs-helm-node-selector)(ref:docs-helm-node-selector).
