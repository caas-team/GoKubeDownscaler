...
For every resource in this list the Helm Chart will create a set of [permissions](ref:docs-helm-permissions) and assign them to the role for the GoKubeDownscaler.
