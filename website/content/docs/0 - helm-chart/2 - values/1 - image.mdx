...
If left empty like it is by default the GoKubeDownscaler will use the [appVersion](repo:deployments/chart/Chart.yaml#L10) of the currently used Helm Chart.
