...
description: GoKubeDownscaler: open-source Kubernetes controller that automatically scales workloads to zero on a schedule to reduce cloud costs. Deploy with Helm.
keywords:
  - kube downscaler
  - introduction
  - architecture
