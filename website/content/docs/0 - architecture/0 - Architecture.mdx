---
title: Introduction And Architecture | GoKubeDownscaler
id: introduction
...
keywords: [kube downscaler, introduction, architecture, cloud, kubernetes, eks, gke, aks, cost optimization, finops]
---
...
- **Outside Company Working Hours:** Automatically scale down non-essential workloads during evenings,
  weekends, or after office hours to reduce costs when demand is low.
- **Holidays:** Scale down workloads during company holidays such as Christmas, Easter, or bank holidays when activity is minimal.
- **Development and Testing Environments:** During periods of low usage, such as overnight, launch break,
  or between development sprints, scale down non-essential development or testing workloads.
...
INSERT CLUSTER-WIDE ARCHITECTURE IMAGE
...
INSERT NAMESPACE-SCOPED ARCHITECTURE IMAGE
