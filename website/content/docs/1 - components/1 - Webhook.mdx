...
description: >
  Learn about the GoKubeDownscaler Webhook component: how it validates and enforces annotations on
  Kubernetes workloads to ensure correct downscaling behavior.
