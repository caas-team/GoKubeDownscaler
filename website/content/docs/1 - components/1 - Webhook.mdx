...
description: Learn about the GoKubeDownscaler Webhook component: how it validates and enforces annotations on Kubernetes workloads to ensure correct downscaling behavior.
...
<script type="application/ld+json">
  {JSON.stringify({
    ...
    "@type": "TechArticle",
    "@id": "https://kube-downscaler.io/docs/components-webhook#techarticle",
    headline: "Webhook — GoKubeDownscaler",
    description:
      "Learn about the GoKubeDownscaler Webhook component: how it validates and enforces annotations on Kubernetes workloads to ensure correct downscaling behavior.",
    articleSection: "Components - Webhook",
    keywords: ["webhook", "mutating webhook", "admission", "kubernetes"],
    url: "https://kube-downscaler.io/docs/components-webhook",
    image: "https://kube-downscaler.io/img/social-preview.png",
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://kube-downscaler.io/docs/components-webhook",
    },
