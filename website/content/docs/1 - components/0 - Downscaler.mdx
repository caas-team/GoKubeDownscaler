...
description: Learn about the GoKubeDownscaler main component: how it scans Kubernetes workloads, applies scaling schedules, and reduces your cloud infrastructure costs.
...
<script type="application/ld+json">
  {JSON.stringify({
    ...
    description:
      "Learn about the GoKubeDownscaler main component: how it scans Kubernetes workloads, applies scaling schedules, and reduces your cloud infrastructure costs.",
