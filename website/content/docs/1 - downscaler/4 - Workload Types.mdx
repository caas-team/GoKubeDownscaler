---
title: Workload Types | GoKubeDownscaler
id: workload-types
...
keywords: [kube downscaler, supported, workloads, cloud, kubernetes, eks, gke, aks, cost optimization]
---

# Workload Types

Valid values for the workload type are the case-insensitive kubernetes resource names of the workloads.
Workload types to be included in the scaling process can be specified using the `--include-resources` argument
at the [CLI Scope](ref:docs-cli-scope#runtime-configuration)
