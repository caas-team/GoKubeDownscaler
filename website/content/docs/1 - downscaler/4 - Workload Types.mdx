...
Workload types to be included in the scaling process can be specified using the [`--include-resources`](ref:docs-values#include-resources) argument
...
When scaled objects are [being scaled](ref:docs-values#include-resources) the downscaler will
