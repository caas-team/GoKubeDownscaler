---
title: CLI Scope | GoKubeDownscaler
id: cli-scope
globalReference: docs-cli-scope
description: Learn how to set the CLI Scope in GoKubeDownscaler
keywords: [kube downscaler, cli scope, basic guide, cloud, kubernetes, eks, gke, aks, cost optimization]
---
