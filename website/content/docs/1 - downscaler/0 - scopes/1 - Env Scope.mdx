...
This is not necessary if [forceRestartOnConfigChange](ref:docs-helm-force-restart-on-config-change) is set to true
since they will then automatically restart.
