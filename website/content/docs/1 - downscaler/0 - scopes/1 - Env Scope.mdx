---
title: Env Scope | GoKubeDownscaler
id: env-scope
globalReference: docs-env-scope
description: Learn how to set the Env Scope in GoKubeDownscaler
keywords: [kube downscaler, env scope, basic guide, cloud, kubernetes, eks, gke, aks, cost optimization]
---
...
At Env Scope, the following environment variables [values](ref:docs-values)
