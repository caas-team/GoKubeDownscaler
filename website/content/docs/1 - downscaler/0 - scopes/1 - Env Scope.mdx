...
scaling policies across targeted resources. These global settings can be overridden by more specific scopes in the
hierarchy.
...
`EXCLUDE_DEPLOYMENTS`, despite its name, is not limited to target deployments. This variable can be used to exclude
any workload type
