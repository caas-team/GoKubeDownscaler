---
title: Namespace Scope | GoKubeDownscaler
id: namespace-scope
globalReference: docs-namespace-scope
description: Learn how to set the Namespace Scope in GoKubeDownscaler
keywords: [kube downscaler, namespace scope, basic guide, cloud, kubernetes, eks, gke, aks, cost optimization]
---
...
INSERT HIERARCHICAL SCOPE IMAGE WITH NAMESPACE SCOPE HIGHLIGHTED
