---
title: Runtime Configuration | GoKubeDownscaler
id: runtime-configuration
globalReference: docs-runtime-configuration
description: Learn what runtime confiugrations are available for GoKubeDownscaler and how to use them
keywords: [kube downscaler, runtime confiugrations, basic guide, cloud, kubernetes, eks, gke, aks, cost optimization]
---
