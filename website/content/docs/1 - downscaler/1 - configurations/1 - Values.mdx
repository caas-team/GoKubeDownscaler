---
title: Values | GoKubeDownscaler
id: values
globalReference: docs-values
description: Learn what values are available for GoKubeDownscaler and how to use them
keywords: [kube downscaler, values, basic guide, cloud, kubernetes, eks, gke, aks, cost optimization]
---
...
Some values within in a scope set/define very similar properties (e.g. [Force Downtime](#force-downtime)
