...
- The Replica count the [workload](ref:docs-workload-types) will be scaled to during downtimes.
  For some resources
  the replica count can also be specified as a percentage value (e.g. `50%`).
  Read carefully the documentation page
  of the [Replicas type](ref:docs-replicas) to understand how to set this value.
