---
title: Timespans | GoKubeDownscaler
id: timespans
globalReference: docs-timespans
description: Learn how to use the Timespans type in GoKubeDownscaler
keywords: [kube downscaler, timespans, basic guide, cloud, kubernetes, eks, gke, aks, cost optimization]
---
...
- Never/False: never matches, acts as a [non-unset state](ref:docs-scopes)
