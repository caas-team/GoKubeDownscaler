---
title: Regex List | GoKubeDownscaler
id: regex-list
globalReference: docs-regex-list
description: Learn how to use regex lists in GoKubeDownscaler.
keywords: [kube downscaler, regex lists, basic guide, cloud, kubernetes, eks, gke, aks, cost optimization]
---
