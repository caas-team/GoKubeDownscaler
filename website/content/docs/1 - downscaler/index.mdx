...
This section covers the main documentation of the Downscaler. The following pages will go in depth on the following
topics:

- [Scopes And Scaling](ref:docs-scopes): How the Downscaler works and how it can be used to scale workloads
- [Workload Types](ref:docs-workload-types): List all the workload types supported by the Downscaler and explain how
they are scaled
