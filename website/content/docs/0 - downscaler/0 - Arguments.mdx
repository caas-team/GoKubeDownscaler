...
The runtime configuration set by the cli arguments will take precedence over [their respective environment variables](ref:docs-environment-variables#runtime-configuration) if they are both set.
