...
description: Learn how to set up and contribute to the GoKubeDownscaler documentation website built with Docusaurus, including local setup and build instructions.
...
After npm is installed you can install the website's dependencies.
...
There are multiple reasons why reinstalling NPM packages might fix some issues.
