...
This will then automatically [create a new release](ref:contributing-developing-repo#releasing-a-new-version) for the Helm chart via our [workflows](ref:contributing-github-workflows).
