    ...
    <div className="relative overflow-x-hidden overflow-y-visible">
      ...
      <header className="select-none text-white bg-magenta items-center flex pt-10 pb-24 px-8 overflow-hidden relative text-center">
        <div className="px-4 w-full flex flex-col items-center justify-center gap-6">
          ...
          <div
            className="h-28 sm:h-36 md:h-44 flex items-center justify-center"
          ...
          <div style={{ willChange: "transform" }}>
            <p
              className="animate-fade-down text-lg sm:text-xl md:text-2xl lg:text-3xl max-w-4xl m-0"
          ...
          <div
            className="animate-fade-down flex justify-center gap-3 flex-col sm:flex-row"
            style={{ willChange: "transform", minHeight: "2.5rem" }}
          >
            <Button
              name="Get Started"
  ...
  return (
    <Layout title={siteConfig.title} description={siteConfig.tagline}>
      <Head>
        ...
        <meta
          name="keywords"
          content="kube-downscaler, GoKubeDownscaler, kubernetes downscaler, kubernetes cost optimization, scale down kubernetes, kubernetes scheduled scaling, go-kube-downscaler, kubernetes autoscaler"
        />
        ...
        <meta
          name="twitter:image"
          content="https://kube-downscaler.io/img/social-preview.png"
        />
      </Head>
      <HomepageHeader />
      <main>
