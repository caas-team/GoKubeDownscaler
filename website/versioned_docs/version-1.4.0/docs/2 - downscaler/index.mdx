...
description: >
  Learn how GoKubeDownscaler reduces Kubernetes cloud costs: scaling logic, scope hierarchy, supported
  workload types, and how to configure it to save money.
...
- [Scopes And Scaling](ref:docs-scopes-and-scaling): How the Downscaler algorithm works and how it can be used to scale workloads.
...
- [Logs](ref:docs-logs): Explain log levels, structured JSON fields, scaling decisions, and querying examples
