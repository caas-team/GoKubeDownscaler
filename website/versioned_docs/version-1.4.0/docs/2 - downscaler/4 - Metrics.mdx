...
description: >
  Reference all Prometheus metrics on the /metrics port 8085 exposed by GoKubeDownscaler and its webhook,
  including dry-run metrics and Grafana integration.
keywords: [metrics]
---
...
<script type="application/ld+json">
  {JSON.stringify({
    ...
    "@type": "TechArticle",
    "@id": "https://kube-downscaler.io/docs/metrics#techarticle",
    headline: "Metrics — GoKubeDownscaler",
    description:
      "Reference all Prometheus metrics exposed by GoKubeDownscaler and its webhook, including " +
      "dry-run metrics and Grafana integration.",
    articleSection: "Downscaler - Metrics",
    keywords: ["metrics", "prometheus", "webhook", "grafana"],
    url: "https://kube-downscaler.io/docs/metrics",
    image: "https://kube-downscaler.io/img/social-preview.png",
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://kube-downscaler.io/docs/metrics",
    },
