...
description: >
  Explore Kubernetes resources that can be scaled down to zero by KubeDownscaler,
  including Deployments, StatefulSets, Jobs, and more, with their scaling behavior.
...
<script type="application/ld+json">
  {JSON.stringify({
    ...
    "@type": "TechArticle",
    "@id": "https://kube-downscaler.io/docs/workload-types#techarticle",
    headline: "Workload Types — GoKubeDownscaler",
    description:
      "Explore Kubernetes resources that can be scaled down to zero by GoKubeDownscaler, " +
      "including Deployments, StatefulSets, Jobs, and more.",
    articleSection: "Downscaler - Workload Types",
    keywords: [
      "workloads",
      "supported workloads",
      "supported crds",
    ...
    url: "https://kube-downscaler.io/docs/workload-types",
    image: "https://kube-downscaler.io/img/social-preview.png",
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://kube-downscaler.io/docs/workload-types",
    },
...
Here is a list of all the workload types supported by KubeDownscaler and how they are scaled.
