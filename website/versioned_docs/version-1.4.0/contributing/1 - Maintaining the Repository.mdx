...
globalReference: contributing-maintaining-repo
description: >
  Learn how the GoKubeDownscaler repository is maintained, how to manage releases and
  changelogs, and how to contribute as a maintainer to this open-source project.
keywords: [repository, contributing]
---
...
For documentation on the workflows see [this documentation page](ref:contributing-github-workflows).
...
Once merged into main the [workflows](ref:contributing-github-workflows) will automatically start releasing the new version.
For major and minor releases, the release workflow also creates a dedicated branch named `release/<Major>.<Minor>`.
To cherry-pick a change from `main` into one of those release branches, add a label like `backport-to-release/1.4`
...
This will in turn retrigger [the workflow](ref:contributing-github-workflows#check-for-release) run
